...
<html>
    <head>
        ...
        <link href="css/StaffServiceList.css" rel="stylesheet">
    </head>
    <body>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <c:import url="StaffHeader.jsp?services=a"/>
            </c:otherwise>
        </c:choose>
        <form action="MainController" method="post" class="search" style="position: relative; top: 100px;">
            ...
            <button value="searchServiceStaff" name="action" >
    ...
    <script>
        if (window.history.replaceState) {
            window.history.replaceState(null, null, "StaffServiceList.jsp");
        }
    </script>
</html>
        ...
        <div class="wrapper-sign-up fadeInDown" >
            ...
            <div id="formContent1">
                <div class="fadeIn first cen1" style="margin: 5px auto">
                    ...
                    <h4 style="margin: 20px; font-size: 30px; text-align: center">ADD NEW STAFF</h4>
                    <br>
                </div>
                <div class="form-con">
                    <form action="MainController" method="POST">
                        ...
                        <input type="submit" class="fadeIn second button " value="Add New Staff" />
                    </form> 
                    <div class="goback-button">
                        <a href="ADB_StaffPage.jsp">Back to Staff Page</a>
                    </div>
                </div>

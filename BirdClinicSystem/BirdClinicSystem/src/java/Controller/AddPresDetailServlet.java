 ...
 * @author ASUS
 */
public class AddPresDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int check = PrescriptionDAO.addNewPresDetail(presID, medID, quantity, usage);
            
            request.setAttribute("appID", appID);
            request.setAttribute("docID", docID);
            request.setAttribute("app", app);
            request.setAttribute("presID", presID);
            request.getRequestDispatcher("PrescriptionServlet").forward(request, response);

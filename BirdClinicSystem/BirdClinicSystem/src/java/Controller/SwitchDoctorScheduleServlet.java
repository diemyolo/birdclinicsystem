 ...
 * @author Admin
 */
public class SwitchDoctorScheduleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("weekYear", weekYear);
            request.getRequestDispatcher("Doctor_AppointmentSchedule.jsp").forward(request, response);
        }
    }

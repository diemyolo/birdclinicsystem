 ...
 * @author ASUS
 */
public class ChangeProfileAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String keepemail = admin.getEmail();
...
//                out.println(oldUser);
            ...
            if (result) {
                Users newAdmin = (Users) UserDAO.getUsersWithMail(keepemail);
                session.setAttribute("admin", newAdmin);
                session.setAttribute("adminname", newAdmin.getFullname());
            ...
            request.getRequestDispatcher("ADB_Profile.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

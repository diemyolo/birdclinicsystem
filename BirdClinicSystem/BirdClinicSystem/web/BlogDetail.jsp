    ...
    <body>
        ...
        <div class="blog_detail_body">
            <div class="blog_content">
                ...
                <div class="blog_img">
                    <img src="img/blog_detail_pic.png" alt"/>
                </div>
                ...
                <div class="recent_blog">
                    ...
                    <div class="recent_blog_list">
                        <div class="blogIndex">
                            ...
                            <h6>How Regular Avian Veterinary Check-ups Keep Your Birds in Peak Condition</h6>
                        </div>
                        <div class="blogIndex">
                            <img src="img/Blog_pic 03.png"/> 
                            <h6>A Safe Haven in Your Home: Essential Tips for Bird-Proofing and Ensuring Safety</h6>
                        </div>
                        <div class="blogIndex">
                            <img src="img/Blog_pic 04.png"/> 
                            <h6>Unmasking Common Avian Diseases and Prevention Strategies</h6>
                        </div>
                    </div>
                </div>
        ...
        <script>
            if (window.history.replaceState) {
                window.history.replaceState(null, null, "BlogDetail.jsp");
            }
        </script>
    </body>
</html>

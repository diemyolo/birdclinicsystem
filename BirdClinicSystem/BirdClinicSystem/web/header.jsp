...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="left-header-user col-md-4" >
                    <h3><a class="underlineHoverlogin" href="login">Login/Register</a></h3>          
                </div>
            </div>
        </div>
        <form id="viewPaginatedDoctor" action="MainController" method="POST">
            <input name="action" type="hidden" value="viewPaginatedDoctor">
    ...
    <script>
        ...
        document.getElementById("viewPaginatedDoctor").submit();
    }
    </script>
</html>
